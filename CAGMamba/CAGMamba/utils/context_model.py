...
class roberta_en_context(nn.Module):
    ...
    def __init__(self):        
        super().__init__() 
        self.roberta_model = AutoModel.from_pretrained('/home/yyk/yyk09/models/roberta-large') # with context, we can improve using a larger model
...
class rob_d2v_cc_context(nn.Module):            
    def __init__(self, config):        
        super().__init__()
        self.roberta_model = RobertaModel.from_pretrained('/home/yyk/yyk09/models/roberta-large')
        self.data2vec_model = Data2VecAudioModel.from_pretrained("/home/yyk/yyk09/models/data2vec-audio-base")
...
class rob_d2v_cme_context(nn.Module):            
    def __init__(self, config):        
        super().__init__()
        self.roberta_model = RobertaModel.from_pretrained('/home/yyk/yyk09/models/roberta-large')
        self.data2vec_model = Data2VecAudioModel.from_pretrained("/home/yyk/yyk09/models/data2vec-audio-large-960h")
